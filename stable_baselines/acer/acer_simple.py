            ...
            with self.graph.as_default():
                ...
                with tf.compat.v1.variable_scope("loss", reuse=False):
                    ...
                    if continuous:
                        ...
                        distribution_f = tf_distrib.MultivariateNormalDiag(
                        ...
                        f_polyak = tf_distrib.MultivariateNormalDiag(
                ...
                with tf.compat.v1.variable_scope("input_info", reuse=False):
                    ...
                    tf.compat.v1.summary.scalar('action_probabilty', tf.reduce_mean(input_tensor=self.mu_ph))
                    ...
                    if self.full_tensorboard_log:
                        ...
                        tf.compat.v1.summary.histogram('action_probabilty', self.mu_ph)
