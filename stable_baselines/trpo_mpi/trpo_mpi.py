            ...
            with self.sess.as_default():
                ...
                while True:
                    ...
                    for k in range(self.g_step):
                        ...
                        with rlscope_common.rlscope_prof_operation('estimate_advantage'):
                        ...
                        with self.timed("computegrad"), rlscope_common.rlscope_prof_operation('estimate_policy_gradient'):
                        ...
                        if np.allclose(grad, 0):
                            ...
                            with self.timed("conjugate_gradient"), rlscope_common.rlscope_prof_operation('estimate_conjugate_gradient'):
                            ...
                            with rlscope_common.rlscope_prof_operation('estimate_proposed_step'):
                        ...
                        with self.timed("vf"), rlscope_common.rlscope_prof_operation('final_update'):
