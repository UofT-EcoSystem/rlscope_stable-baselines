...
class TD3(OffPolicyRLModel):
    ...
    def _train_step(self, step, writer, learning_rate, update_policy):
        ...
        if update_policy:
            # NOTE: In addition to policy, we are updating target networks.
    ...
    def is_warmed_up(self):
        ...
        :return:
        """
        return self.replay_buffer.can_sample(self.batch_size) and self.num_timesteps >= self.learning_starts
