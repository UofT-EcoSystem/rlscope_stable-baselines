                ...
                for step in range(total_timesteps):
                    ...
                    if step % self.train_freq == 0:
                        ...
                        for grad_step in range(self.gradient_steps):
                            ...
                            # IML TODO: # In the SAC paper, they split self._train_step into 2 lines:
                            # 1) "Update the Q-function parameters"
                            # 2) "Update the policy weights"
                            # We should explicitly separate these operations to make
                            # their individual contribution to training clear.
                            with iml.prof.operation('update_actor_and_critic'):
